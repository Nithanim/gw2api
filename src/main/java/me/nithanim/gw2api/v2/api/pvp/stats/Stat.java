...
public class Stat {
  ...
  /**
   * Returns statistics from all matches ever played over all professions. You can use {@link
   * #getProfessions()} to get statistics grouped by profession.
   *
  ...
  /**
   * Returns statistics of all matches per profession. To get a summary of all professions combined
   * use {@link #getAggregate()}.
   *
