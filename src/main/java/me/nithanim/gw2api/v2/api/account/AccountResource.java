...
/**
 * This resource returns information about player accounts. This endpoint is only accessible with a
 * valid API key.
 *
 * @see <a
 *     href="https://wiki.guildwars2.com/wiki/API:2/account">https://wiki.guildwars2.com/wiki/API:2/account</a>
 */
public class AccountResource implements ApiMidpoint, ApiEndpoint {
  ...
  /**
   * This resource returns the achievements of the account. This endpoint is only accessible with a
   * valid API key.
   *
   * @param apiKey
   * @return
  ...
  public AchievementStatus[] achievements(String apiKey) {
    return RequestHelper.INSTANCE.getRequest(
        achievementsWebTarget, apiKey, AchievementStatus[].class);
  }
  ...
  /**
   * The endpoint returns an array of objects, each representing an item slot in the vault. If a
   * slot is empty, it will return null. The amount of slots/bank tabs is implied by the length of
   * the array.
   *
   * @param apiKey
   * @return
   * @see <a
   *     href="https://wiki.guildwars2.com/wiki/API:2/account/bank">https://wiki.guildwars2.com/wiki/API:2/account/bank</a>
   */
  ...
  /**
   * This resource returns the unlocked dyes of the account. This endpoint is only accessible with a
   * valid API key.
   *
   * @param apiKey
   * @return
  ...
  /**
   * This resource returns the materials stored in a player's vault. This endpoint is only
  ...
  /**
   * This resource returns the minis of the account. This endpoint is only accessible with a valid
   * API key.
   *
   * @param apiKey
   * @return
  ...
  /**
   * This resource returns the unlocked skins of the account. This endpoint is only accessible with
   * a valid API key.
   *
   * @param apiKey
   * @return
  ...
  /**
   * This resource returns the currencies of the account. This endpoint is only accessible with a
   * valid API key.
   *
   * @param apiKey
   * @return
