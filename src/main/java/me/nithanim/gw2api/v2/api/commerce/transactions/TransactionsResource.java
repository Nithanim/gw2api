...
/**
 * This resource provides access to the current and historical transactions of a player. This is an
 * authenticated endpoint. Results are cached for five minutes.
 *
 * @see <a
 *     href="https://wiki.guildwars2.com/wiki/API:2/commerce/transactions">https://wiki.guildwars2.com/wiki/API:2/commerce/transactions</a>
 */
public class TransactionsResource implements ApiEndpoint {
  ...
  public PaginationResult<Transaction[]> currentBuysExtendedWithPageSize(
      String apiKey, int pageSize) {
    return queryApiWithPageSize(currentBuys, apiKey, pageSize);
  }

  public PaginationResult<Transaction[]> currentBuysExtendedWithPageAndPageSize(
      String apiKey, int page, int pageSize) {
  ...
  public PaginationResult<Transaction[]> currentSellsExtendedWithPageSize(
      String apiKey, int pageSize) {
    return queryApiWithPageSize(currentSells, apiKey, pageSize);
  }

  public PaginationResult<Transaction[]> currentSellsExtendedWithPageAndPageSize(
      String apiKey, int page, int pageSize) {
  ...
  public PaginationResult<Transaction[]> historyBuysExtendedWithPageSize(
      String apiKey, int pageSize) {
    return queryApiWithPageSize(historyBuys, apiKey, pageSize);
  }

  public PaginationResult<Transaction[]> historyBuysExtendedWithPageAndPageSize(
      String apiKey, int page, int pageSize) {
  ...
  public PaginationResult<Transaction[]> historySellsExtendedWithPageSize(
      String apiKey, int pageSize) {
    return queryApiWithPageSize(historySells, apiKey, pageSize);
  }

  public PaginationResult<Transaction[]> historySellsExtendedWithPageAndPageSize(
      String apiKey, int page, int pageSize) {
  ...
  private PaginationResult<Transaction[]> queryApiWithPage(WebTarget wr, String apiKey, int page) {
    return RequestHelper.INSTANCE.getRequestExtended(
        wr, apiKey, Transaction[].class, "page", String.valueOf(page));
  }

  private PaginationResult<Transaction[]> queryApiWithPageSize(
      WebTarget wr, String apiKey, int pageSize) {
    return RequestHelper.INSTANCE.getRequestExtended(
        wr, apiKey, Transaction[].class, "page_size", String.valueOf(pageSize));
  }

  private PaginationResult<Transaction[]> queryApiWithPageAndPageSize(
      WebTarget wr, String apiKey, int page, int pageSize) {
    return RequestHelper.INSTANCE.getRequestExtended(
        wr,
        apiKey,
        Transaction[].class,
